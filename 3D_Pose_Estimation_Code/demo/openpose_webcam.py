...
POSE_PAIRS = [["Nose",  "Neck"], ["Nose",  "REye"], ["Nose",  "LEye"], [ "Neck", "RShoulder"], [ "Neck", "LShoulder"],
              [ "Neck", "MidHip"], ["MidHip", "RHip"], ["MidHip", "LHip"], ["RHip", "RKnee"], ["LHip", "LKnee"], ["RShoulder", "RElbow"],
                      ["RElbow", "RWrist"], ["LShoulder","LElbow"], ["LElbow",  "LWrist"], ["RKnee", "RAnkle"],
              ["LKnee", "LAnkle"], [ "REye", "REar"], [ "LEye", "LEar"], [ "LAnkle", "LHeel"], ["LBigToe", "LHeel"], ["LSmallToe", "LHeel"],
...
# mpii
#protoFile = str(BASE_DIR) + "/mywork/openpose_model/mpi/pose_deploy_linevec_faster_4_stages.prototxt"
#weightsFile = str(BASE_DIR) + "/mywork/openpose_model/mpi/pose_iter_160000.caffemodel"
# body25
protoFile = str(BASE_DIR) + "/mywork/openpose_model/body_25/pose_deploy.prototxt"
weightsFile = str(BASE_DIR) + "/mywork/openpose_model/body_25/pose_iter_584000.caffemodel"
